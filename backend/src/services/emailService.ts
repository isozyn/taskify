...
export const sendProjectInvitationEmail = async (
  ...
  try {
    ...
    console.log(`   From: Taskify <${process.env.SMTP_USER}>`);
    console.log(`   Subject: You're invited to join "${projectName}" on Taskify`);
    console.log(`   Inviter: ${inviterName}`);

    // Double-check we're not accidentally using the wrong email
