...
export class ProjectService {
   ...
   */
  static async createProject(data: ProjectCreateInput): Promise<ProjectResponse> {
   ...
   */
  static async getProjectById(projectId: number): Promise<ProjectResponse | null> {
   ...
   */
  static async getProjectsByUserId(userId: number): Promise<ProjectResponse[]> {
