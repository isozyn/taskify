...
import { Trash2, UserPlus, Activity, Crown, User, Mail, Copy, CheckCircle2, Clock, Target, BarChart3, Calendar } from "lucide-react";
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getRoleBadgeColor(selectedMember.role)}`}>
