			...
			<div className="max-w-6xl mx-auto px-6 py-12 mt-16">
				...
				<div className="text-center mb-12">
					...
					<p className="text-lg text-slate-600 max-w-2xl mx-auto">
						...
						Each template is designed for specific project types and
						team workflows.
					</p>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
					...
					>
						...
						<div className="p-8 bg-white">
							...
							<p className="text-slate-700 mb-6 leading-relaxed">
								Perfect for deadline-driven teams and
								time-sensitive projects. Tasks automatically
								move between stages based on their dates,
								...
								<div className="space-y-3">
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Tasks transition through stages
												based on start and due dates
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Built-in support for agile
												methodologies and milestone
												tracking
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												...
												completion metrics for each task
											</p>
										</div>
									</div>
								</div>
					...
					>
						...
						<div className="p-8 bg-white">
							...
							<p className="text-slate-700 mb-6 leading-relaxed">
								Ideal for creative teams with unique processes
								and flexible timelines. Design your own workflow
								stages and move tasks manually between them with
								...
								<div className="space-y-3">
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Create as many workflow stages
												as you need for your process
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Intuitive task movement between
												columns with smooth animations
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												No automatic task movement - you
												decide when tasks move forward
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Trello-style quick add cards in
												any column for rapid task entry
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-3">
										...
										<div>
											...
											<p className="text-xs text-slate-600">
												Rename, reorder, add, or remove
												columns to match your workflow
											</p>
										</div>
									</div>
								</div>
				...
				<div className="flex items-center justify-between p-6 bg-white rounded-xl border-2 border-slate-200 shadow-sm">
					<div>
						...
						<p className="text-xs text-slate-500 mt-1">
							💡 You can switch templates later in Project
							Settings
						</p>
					</div>
					<Button
